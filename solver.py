import cProfile
from branch_heuristics import select_literal
from utils import *
...
result, splits = dpll([frozenset(clause) for clause in solver_clauses], verbose=False, method="GUP")
print(splits)

profiler.disable()
profiler.dump_stats("profile_output.prof")
# resolution([frozenset(clause) for clause in solver_clauses], verbose=True, dp=False)
